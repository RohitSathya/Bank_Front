...
const LoanApplicationComponent = ({data}) => {
  ...
  const submitApplication = async () => {
     ...
     const res=await axios.post(link+'api/transaction/apply-loan',{userId:parse.accountno,loanAmount:loanAmount,durationMonths:duration,name:name,balance:data})
