...
export default function register() {
  ...
  const handleMouseDownPassword = (event) => {
    ...
    async function sub(){
        ...
        if(check){
            const response=await axios.post(link+'api/auth/register',{username:username,email:email,password:password,address:address,phone:phoneno,depositType:depositType})
